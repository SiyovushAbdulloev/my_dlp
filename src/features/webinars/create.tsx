...
export const webinarFormSchema = z.object({
  topic: z.object({
    ru: z.string().min(1, 'Тема на русском обязательно'),
    en: z.string().min(1, 'Тема на английском обязательно'),
    tg: z.string().min(1, 'Тема на таджикском обязательно'),
  }),
  start_date: z.date({ message: 'Дата начала обязательно' }),
  start_time: z.string({ message: 'Время начала обязательно' }),
})

export type WebinarForm = z.infer<typeof webinarFormSchema>
