...
export function defineAbilitiesFor(user: User | null) {
  ...
  //Course modules
  if (permissions.find((p) => p.name === 'course_modules_list')) {
    can('list', 'course_modules')
  }
  if (permissions.find((p) => p.name === 'course_modules_create')) {
    can('create', 'course_modules')
  }
  if (permissions.find((p) => p.name === 'course_modules_view')) {
    can('view', 'course_modules')
  }
  if (permissions.find((p) => p.name === 'course_modules_edit')) {
    can('edit', 'course_modules')
  }
  if (permissions.find((p) => p.name === 'course_modules_delete')) {
    can('delete', 'course_modules')
  }

  //Course module lessons
  if (permissions.find((p) => p.name === 'course_lessons_list')) {
    can('list', 'course_lessons')
  }
  if (permissions.find((p) => p.name === 'course_lessons_create')) {
    can('create', 'course_lessons')
  }
  if (permissions.find((p) => p.name === 'course_lessons_view')) {
    can('view', 'course_lessons')
  }
  if (permissions.find((p) => p.name === 'course_lessons_edit')) {
    can('edit', 'course_lessons')
  }
  if (permissions.find((p) => p.name === 'course_lessons_delete')) {
